...
var a='data-src'; if($('.js7').hasAttr('src')) { a='src'; } $('.js7').attr(a, 'images/facebook-logo-transparent-back-110.png');}else{$('.js2').attr('src', (dpi>1) ? 'images/ridingretroplainsquare_clipped_rev_2-copy-746.png' : 'images/ridingretroplainsquare_clipped_rev_2-copy-373.png');
