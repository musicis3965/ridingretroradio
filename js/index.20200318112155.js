...
var a='data-src'; if($('.js9').hasAttr('src')) { a='src'; } $('.js9').attr(a, 'images/facebook-logo-transparent-back-110.png');}else{$('.js2').attr('src', (dpi>1) ? 'images/img_6022copy-960.jpg' : 'images/img_6022copy-480.jpg');
...
var a='data-src'; if($('.js9').hasAttr('src')) { a='src'; } $('.js9').attr(a, 'images/facebook-logo-transparent-back-94.png');}}};
