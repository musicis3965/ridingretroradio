...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/ambiance002-1510.png':'images/ambiance002-755.png');};
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un3'), "1.80s", "0.00s", 1, 100);
wl.addAnimation($('.un5'), "2.20s", "0.00s", 1, 100);
wl.addAnimation($('.un7'), "2.20s", "0.00s", 1, 100);
wl.addAnimation($('.un9'), "2.20s", "0.00s", 1, 100);
wl.addAnimation($('.un11'), "2.20s", "0.00s", 1, 100);
wl.addAnimation($('.un13'), "2.20s", "0.00s", 1, 100);
wl.start();
